...
function App() {
  ...
  return (
    <div className="h-screen bg-white text-black flex flex-col overflow-hidden">
      <header className={`py-6 px-8 flex justify-between items-center border-b border-black bg-white transition-all duration-300 ${scrollY > 20 ? 'shadow-sm' : ''} flex-shrink-0`}>
        <motion.h1 
...
function WorkSection({ projects }) {
  ...
  return (
    <div className="flex h-full">
      <div className="w-1/3 pr-6 overflow-y-auto px-8 py-6">
        <motion.h2 
        ...
        >
          ...
          <div className="mb-6 hover:bg-gray-50 p-3 rounded-lg transition-colors duration-200">
      ...
      <div className="w-2/3 overflow-y-auto px-8 py-6">
        <motion.h3 
        ...
        >
          {projects.map((project, index) => (
            <motion.div
              key={project.id}
              className={`flex justify-between items-center hover:bg-gray-50 p-3 rounded-lg cursor-pointer transition-colors duration-200 ${index !== projects.length - 1 ? 'mb-2' : ''}`}
              whileHover={{ x: 5 }}
...
function AboutSection() {
  return (
    <div className="flex h-full">
      <div className="w-1/3 pr-6 px-8 py-6">
        <motion.div
      ...
      <div className="w-2/3 overflow-y-auto px-8 py-6">
          ...
          <motion.div
            ...
            transition={{ delay: 0.3, duration: 0.5 }}
          >
            <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-100 hover:shadow-sm transition-shadow duration-200">
